...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/coaching/for-${page.slug}` },
    openGraph: {
      title: page.meta.title,
      description: page.meta.description,
      url: `https://coachjack.xyz/coaching/for-${page.slug}`,
    },
  };
}
    ...
    <>
      ...
      <JsonLd
        data={createBreadcrumbSchema([
          ...
          { name: page.hero.headline, url: `${base}/coaching/for-${page.slug}` },
        ])}
      />
